...
class TiedMultivectorAttention(Multivector2MultivectorAttention, MultivectorAttention):
    ...
    :py:class:`MultivectorAttention`) or rotation-equivariant result (as
    :py:class:`Multivector2MultivectorAttention`), this layer returns both
